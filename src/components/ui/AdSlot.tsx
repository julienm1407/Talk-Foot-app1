    ...
    <Card elevation="none" className="overflow-hidden">
      <div className={`bg-gradient-to-br ${gradient}`}>
        ...
        <div className="px-5 py-4">
          ...
          <div className="mt-3 inline-flex items-center gap-2 rounded-2xl bg-white/80 px-3 py-2 text-xs font-black text-slate-900 ring-1 ring-slate-200 cursor-pointer hover:bg-white transition">
            Découvrir
