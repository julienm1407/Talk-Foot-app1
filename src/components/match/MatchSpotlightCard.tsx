...
export function MatchSpotlightCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 border-t border-white/10 bg-[#050a12]/92 px-4 py-3.5 backdrop-blur-sm">
        {fixtureMetaLine(match) ? (
          <p className="text-center text-[11px] font-semibold leading-snug text-white/70">
            {fixtureMetaLine(match)}
          </p>
        ) : null}
