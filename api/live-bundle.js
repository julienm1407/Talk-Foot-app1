...
const LIVE_BUNDLE_INCLUDE =
  'participants;league;venue;state;scores;periods;events.type;events.period;events.player;statistics.type;sidelined.sideline.player;sidelined.sideline.type;weatherReport;comments;lineups.player;lineups.type;lineups.details.type;metadata.type;coaches;formations;trends.type;trends.participant;xGFixture.type'
