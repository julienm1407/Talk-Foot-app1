...
const NATION_ALIASES = {
  ...
  COG: ['congo brazzaville', 'republique du congo', 'république du congo'],
  COD: ['rd congo', 'rdc', 'republique democratique du congo', 'république démocratique du congo', 'congo rd', 'dr congo'],
  JPN: ['japon'],
