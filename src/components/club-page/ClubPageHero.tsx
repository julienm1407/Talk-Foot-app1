    ...
    <>
      <section
        className={cn(
          ...
          data.onFire && 'ring-1 ring-amber-500/25',
        )}
      >
        <div
        ...
        <div className="relative z-[1] mx-auto flex max-w-tf-wide flex-col items-center px-3 pb-8 pt-6 sm:px-5 sm:pb-10 sm:pt-8">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-sky-200/75">{data.heroTag}</p>
          <div className="mt-2.5 flex items-center gap-3 sm:mt-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm font-bold text-sky-200/80">Hub social Talk Foot — générique</p>
            </div>
          </div>
